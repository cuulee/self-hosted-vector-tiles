...
@serif_bd: 'Fira Sans ExtraBold', @fallback;
@serif_it: 'Fira Sans ExtraLight Italic', @fallback;
//sans
...
@sans_it: 'Fira Sans Eight Italic', @fallback;
@sans_it_md: 'Meta Offc Pro Medium Italic', @fallback;
@sans_it_bd: 'Meta Offc Pro Bold Italic', @fallback;
*/
@serif: 'Fira Sans Regular', @fallback;
@serif_md: 'Fira Sans Medium', @fallback;
@serif_bd: 'Fira Sans ExtraBold', @fallback;
@serif_it: 'Fira Sans ExtraLight Italic', @fallback;
//sans
@sans: 'Fira Sans', @fallback;
@sans_md: 'Fira Sans Medium', @fallback;
@sans_bd: 'Fira Sans Book Italic', @fallback;
@sans_bk: 'Fira Sans Extra Bold', @fallback;
@sans_it: 'Fira Sans Eight Italic', @fallback;
@sans_it_md: 'Fira Sans Medium Italic', @fallback;
@sans_it_bd: 'Fira Sans Bold Italic', @fallback;
// ---------------------------------------------------------------------
// Countries
